                        ...
                        {{-- <p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-md-6 col-12">
                                    ...
                                    <input type="text" class="form-control" id="APREN_Nombre" placeholder="Ingrese su nombre..." name="APREN_Nombre" required />
                                ...
                                <div class="col-xl-4 col-md-6 col-12">
                                    ...
                                    <input type="text" class="form-control" id="APREN_Documento" placeholder="Ingrese su documento..." name="APREN_Documento" required />
                                    <div class="valid-tooltip">Looks good!</div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-4 col-md-6 col-12">
                                    ...
                                    <select class="form-select" arial-label="Default select example" name="APREN_Tipo_Documento" id="APREN_Tipo_Documento" required>
                                ...
                                <div class="col-xl-4 col-md-6 col-12">
                                    ...
                                    <select class="form-select" arial-label="Default select example" name="APREN_Genero" id="APREN_Genero" required>
                                ...
                                <div class="col-xl-4 col-md-6 col-12">
                                    ...
                                    <select class="form-select" arial-label="Default select example" name="APREN_Estado" id="APREN_Estado" required>
